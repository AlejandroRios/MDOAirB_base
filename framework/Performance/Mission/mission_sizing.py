...
def mission_sizing(vehicle, airport_departure, airport_destination):
    ...
    final_distance, total_climb_time, total_burned_fuel, final_altitude, _, _, _, _, _, _, _, _, _, _, _, _ = climb_integration(
        max_takeoff_mass,
        mach_climb,
        climb_V_cas,
        delta_ISA,
    ...
    while flag == 1 and iteration <100:
        ...
        # start_time = datetime.now()
        final_distance, total_descent_time, total_burned_fuel, final_altitude, _, _, _, _, _, _, _, _, _, _, _, _ = descent_integration(
            final_cruise_mass,
            mach_descent,
            descent_V_cas,
            delta_ISA,
