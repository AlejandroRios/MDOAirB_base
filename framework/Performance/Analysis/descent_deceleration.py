...
def decelaration_to_250(rate_of_climb, descent_V_cas, delta_ISA, vehicle):
    ...
    while delta_error > 100:
        ...
        if engine['type'] == 0:
            ...
            fuel_flow_1 = nn_unit_FC.predict(scaler_FC.transform([(10000, mach_1, 0.4)]))
            fuel_flow_2 = nn_unit_FC.predict(scaler_FC.transform([(10000+delta_altitude_initial, mach_2, 0.4)]))      
