...
def network_optimization(computation_mode, airports_keys, distances, demands, doc0, vehicle):
    ...
    if (computation_mode == 0):
        ...
        aircrafts01 = LpVariable.dicts("aircrafts",(arcs),0,10,LpInteger)
        aircrafts02 = LpVariable.dicts("aircrafts",(arcs),0,10,LpInteger)
        aircrafts03 = LpVariable.dicts("aircrafts",(arcs),0,10,LpInteger)
