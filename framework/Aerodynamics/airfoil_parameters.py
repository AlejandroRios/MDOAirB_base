...
def airfoil_sobieski_coefficients(fileToRead1):
    ...
    LB=np.array([0.015, 0.08,  -0.24, 0.20, -0.2, -0.300, -0.050, -0.050, 0.5,0.0025,0])
    UB=np.array([0.20 , 0.16,   0.10, 0.46,  0.1, -0.005, 0.030, 0.025, 0.80,0.0025,0])

    bnds = ((0.015,0.2),(0.08,0.16),(-0.24,0.1),(0.2,0.46),(-0.2,0.1),(-0.3,-0.005),(-0.05,0.03),(-0.05,0.25),(0.5,0.8),(0.0025,0.0025),(0,0))
