...
def main(argv):
    ...
    x = [
            ...
            100,  #BPR x 10
            25,  #FanDiameter X 10
            27,  #Compressor pressure ratio
            1350,  #turbine inlet temperature
            15,  #FPR x 10
            250,  #PAX number
            6,  #seat abreast
            3000,  #range
    ...
    for wa in WingArea:
        for fd in FanDiameter:
            ...
            doc, fuel_mass, total_mission_flight_time, mach, passenger_capacity, SAR = objective_function_FPO(
